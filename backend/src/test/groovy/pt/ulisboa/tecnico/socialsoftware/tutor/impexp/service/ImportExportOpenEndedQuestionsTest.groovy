...
class ImportExportOpenEndedQuestionsTest extends SpockTest {
    ...
    def setup() {
        ...
        openEndedQuestionDto.setCriteria(QUESTION_1_CONTENT)
        openEndedQuestionDto.setRegexQuestion(QUESTION_4_REGEX)
    ...
    def 'export and import questions to xml'() {
        ...
        OpenEndedDetailsDto.getCriteria() == QUESTION_1_CONTENT
        OpenEndedDetailsDto.getRegexQuestion() == QUESTION_4_REGEX
    }
