...
class DiscussionFixtureSpockTest extends SpockTest {
    ...
    def defineBaseFixture() {
        ...
        def optionsList = new ArrayList<Option>()
        optionsList.add(optionRepository.findAll().get(0))
        ...
        def answerDetails2 = new MultipleChoiceAnswer(questionanswer, optionsList);
