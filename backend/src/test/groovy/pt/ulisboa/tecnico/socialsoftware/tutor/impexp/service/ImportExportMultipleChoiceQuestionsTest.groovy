...
class ImportExportMultipleChoiceQuestionsTest extends SpockTest {
    ...
    def 'export and import questions to xml'() {
        ...
        optionOneResult.isCorrect() || optionTwoResult.isCorrect()
        optionOneResult.getOrder() == 1
        optionTwoResult.getOrder() == 0
    ...
    def 'export to latex'() {
        ...
        and: "latex representation has the single answer type"
        questionsLatex.contains("answerType")
        questionsLatex.contains("SINGLE")

        and: "option latex representation contains correct order"
        questionsLatex.contains("correctOrder=")
    }
