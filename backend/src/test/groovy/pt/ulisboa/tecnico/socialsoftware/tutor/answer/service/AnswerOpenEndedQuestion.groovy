...
@DataJpaTest
class AnswerOpenEndedQuestion extends SpockTest {

    User user
    QuizQuestion quizQuestion
    OpenEndedAnswer answerOk
    OpenEndedAnswer answerNok
    ...
    def 'conclude quiz with answer, before conclusionDate with correct answer'() {
        ...
        correctAnswerDto.getCorrectAnswerDetails().getRegex() == "^[0-9]*\$"

        ((OpenEndedAnswer)questionAnswer.getAnswerDetails()).getOpenAnswer() == "20"
    }
