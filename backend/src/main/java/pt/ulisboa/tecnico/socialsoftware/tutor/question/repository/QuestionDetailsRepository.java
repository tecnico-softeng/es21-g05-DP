...
public interface QuestionDetailsRepository extends JpaRepository<QuestionDetails, Integer> {
    ...
    @Query(value = "SELECT * FROM question_details q WHERE q.question_type = 'combination_item'", nativeQuery = true)
    List<CodeOrderQuestion> findCombinationItemQuestionDetails();
