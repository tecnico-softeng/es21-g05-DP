...
public enum ErrorMessage {
    ...
    COMBINATION_ITEM_NOT_FOUND("Combination item not found with id %d"),
    ...
    QUESTION_ITEM_MISMATCH("Question does not have item %d"),
    ...
    AT_LEAST_TWO_OPTIONS_PER_GROUP("Item combination questions need to have at least 2 options per group."),
    SAME_GROUP_CONNECTION("Item cannot be connected to another in the same group"),
    AT_LEAST_TWO_GROUPS("Item combination questions need to have at least 2 groups."),
    ONE_CORRECT_OPTION_NEEDED("Single answer questions need to have 1 and only 1 correct option"),
    MORE_THAN_ONE_CORRECT_OPTION_NEEDED("Multiple answer questions need to have more than 1 correct option"),
