...
public abstract class LatexVisitor implements Visitor {
    ...
    public void visitQuestionDetails(MultipleChoiceQuestion question) {
        ...
        this.result = this.result + "% answerType: " + question.getAnswerType().name() + "\n";
    ...
    public void visitOption(Option option) {
        this.result = this.result + "\t\\option" + MultipleChoiceQuestion.convertSequenceToLetter(option.getSequence()) + "{" + option.getContent() + "}correctOrder=" + option.getOrder() +"\n";
    }

    @Override
    public void visitQuestionDetails(OpenEndedQuestion question) {
        this.result = this.result + "% criteria: " + question.getCriteria() + "\n";
        this.result = this.result + "% regex: " + question.getRegexQuestion() + "\n";
        this.result = this.result + "\\end{ClosedQuestion}\n}\n\n";
    }
    ...
    public void visitQuestionDetails(ItemCombinationQuestion question) {
        ...
        this.result = this.result + "% Items: \n\\begin{lstlisting}\n" +
                question.getItems()
                        .stream()
                        .map(CombinationItem::getContent)
                        .collect(Collectors.joining("\n")) + "\n\\end{lstlisting}\n";
    ...
    public void visitCombinationItem(CombinationItem item) {
        ...
        this.result = this.result + "% group: " + item.getGroup().name() + "\n";
        this.result = this.result + "% content: " + item.getContent() + "\n";

        this.result = this.result + "% Connections: \n\\begin{lstlisting}\n" +
                item.getConnections() + "\n\\end{lstlisting}\n";

        this.result = this.result + "% Connection of: \n\\begin{lstlisting}\n" +
                item.getConnectionOf() + "\n\\end{lstlisting}\n";
